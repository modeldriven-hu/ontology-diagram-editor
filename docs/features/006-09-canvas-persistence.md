...
Properties view layout, pan, and zoom shall not be written to the `.odiagram` file. The
selected light/dark render mode is persisted separately as `metadata.theme_mode`.
