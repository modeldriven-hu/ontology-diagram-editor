...
`);
		...
		assert.strictEqual(document.nodes[0].typeDisplay, 'stereotype');
		...
		assert.match(stringifyOntologyDiagramYaml(document), /type_display: stereotype/);
	});
