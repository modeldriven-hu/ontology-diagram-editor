...
export function activate(context: vscode.ExtensionContext) {
	...
	const diagramEditorDisposable = vscode.window.registerCustomEditorProvider(
		...
		}, propertiesView.onDidRequestImageGallery, propertiesView.onDidRequestCanvasSelection, propertiesView.onDidRequestCanvasStyleUpdate, () => modelTree.getLastDraggedItems(), async (diagramElementId) => {
